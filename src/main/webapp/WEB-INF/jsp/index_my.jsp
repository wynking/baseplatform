		...
		<c:if test="${isSuper == 0}">
			...
			<div class="panel-group oneLevelNav-pannel" id="" style="margin-top: 5px; margin-bottom: 5px; ">
				<div class="panel panel-default">
					<div class="panel-heading">
						<h4 class="panel-title">
							<a class="twoLevelNav" url="./organization/list" isLeaf='1'
								href="javascript:void(0);">组织机构管理 </a>
						</h4>
					</div>
				</div>
			</div>
			...
			<div class="panel-group oneLevelNav-pannel" id="" style="margin-top: 5px; margin-bottom: 5px; ">
				<div class="panel panel-default">
					<div class="panel-heading">
						<h4 class="panel-title">
							<a class="twoLevelNav" url="./role/list" isLeaf='1'
								href="javascript:void(0);">角色信息管理 </a>
						</h4>
					</div>
				</div>
			</div>
			...
			<div class="panel-group oneLevelNav-pannel" id="" style="margin-top: 5px; margin-bottom: 5px; ">
				<div class="panel panel-default">
					<div class="panel-heading">
						<h4 class="panel-title">
							<a class="twoLevelNav" url="./resource/list" isLeaf='1'
								href="javascript:void(0);">资源信息管理 </a>
						</h4>
					</div>
				</div>
			</div>
