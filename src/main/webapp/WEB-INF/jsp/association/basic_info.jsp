...
<body>
	...
	<form class="form-horizontal" id="basic_add_form"
		...
		<fieldset>
			<legend>负责人信息</legend>
			<div class="form-group  col-sm-6">
				<label class="col-sm-4 control-label" for="fzrName">姓名</label>
				<div class="col-sm-8">
					<input class="form-control" name="fzrName" type="text"
						placeholder="请输入" />
				</div>
			</div>
			<div class="form-group  col-sm-6">
				<label class="col-sm-4 control-label" for="fzrJob">职务</label>
				<div class="col-sm-8">
					<input class="form-control" name="fzrJob" type="text"
						placeholder="请输入" />
				</div>
			</div>
			<div class="form-group  col-sm-6">
				<label class="col-sm-4 control-label" for="fzrPhone">手机</label>
				<div class="col-sm-8">
					<input class="form-control" name="fzrPhone" type="text"
						placeholder="请输入" />
				</div>
			</div>
			<div class="form-group  col-sm-6">
				<label class="col-sm-4 control-label" for="fzrTel">固话</label>
				<div class="col-sm-8">
					<input class="form-control" name="fzrTel" type="text"
						placeholder="请输入" />
				</div>
			</div>
			<div class="form-group  col-sm-6">
				<label class="col-sm-4 control-label" for="fzrEmail">邮箱</label>
				<div class="col-sm-8">
					<input class="form-control" name="fzrEmail" type="text"
						placeholder="请输入" />
				</div>
			</div>
		</fieldset>
		...
		<fieldset>
			<legend>联系人信息</legend>
			<div class="form-group  col-sm-6">
				<label class="col-sm-4 control-label" for="lxrName">姓名</label>
				<div class="col-sm-8">
					<input class="form-control" name="lxrName" type="text"
						placeholder="请输入" />
				</div>
			</div>
			<div class="form-group  col-sm-6">
				<label class="col-sm-4 control-label" for="lxrJob">职务</label>
				<div class="col-sm-8">
					<input class="form-control" name="lxrJob" type="text"
						placeholder="请输入" />
				</div>
			</div>
			<div class="form-group  col-sm-6">
				<label class="col-sm-4 control-label" for="lxrPhone">手机</label>
				<div class="col-sm-8">
					<input class="form-control" name="lxrPhone" type="text"
						placeholder="请输入" />
				</div>
			</div>
			<div class="form-group  col-sm-6">
				<label class="col-sm-4 control-label" for="lxrTel">固话</label>
				<div class="col-sm-8">
					<input class="form-control" name="lxrTel" type="text"
						placeholder="请输入" />
				</div>
			</div>
			<div class="form-group  col-sm-6">
				<label class="col-sm-4 control-label" for="lxrEmail">邮箱</label>
				<div class="col-sm-8">
					<input class="form-control" name="lxrEmail"  type="text"
						placeholder="请输入" />
				</div>
			</div>
		</fieldset>
