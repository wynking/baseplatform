...
import cn.com.pansky.otp5.baseplatform.controller.BaseController;
...
//	    req.setAttribute("levels", levels);
    ...
    public GridBean<EnterpriseBasicVO> findByPage(HttpServletRequest req,HttpServletResponse resp){
